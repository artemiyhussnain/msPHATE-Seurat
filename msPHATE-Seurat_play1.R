...
marker_plots[[1]] + coord_cartesian(xlim = c(-0.01, 0.02), ylim = c(-0.01, 0.02)) + 
marker_plots[[2]] + coord_cartesian(xlim = c(-0.01, 0.02), ylim = c(-0.01, 0.02)) + 
...
marker_plots[[1]] + marker_plots[[2]] + marker_plots[[3]]
