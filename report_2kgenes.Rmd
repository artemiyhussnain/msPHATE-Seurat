...
- 1 and 5472 beg merging, when zooming in later I'll keep them together. From lvl5 heatmap, they are different in some important way, and I'll see that by zooming in
- lvl4 best corresponds to jansky: 0 - bridge, 1+2736+5472 - chromaffins (connecting and proper), 2 - neuroblasts (proper, cycling, late - resolves in lvl5, can be confirmed by zooming), 10+3784 - SCPs
