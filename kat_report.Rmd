...
saveRDS(bcn_ms, file = paste(wdir, 'bcn_ms_scaled_lvl4_msphate_umap_tsne_2k.RDS', sep = ''))
saveRDS(bcn_ms_unscaled, file = paste(wdir, 'bcn_ms_unscaled_lvl4_msphate_umap_tsne_2k.RDS', sep = ''))
```
...
FeaturePlot(bcn_ms, reduction = 'msphate', features = 'CC.Difference', cols = c('red', 'green'), pt.size = 1.1, combine=FALSE) + coord_cartesian(xlim = c(-0.025, 0.02), ylim = c(-0.015, 0.025))
...
FeaturePlot(bcn_ms_unscaled, reduction = 'msphate', features = 'CC.Difference', cols = c('red', 'green'), pt.size = 1.1, combine = FALSE) + coord_cartesian(xlim = c(-0.025, 0.02), ylim = c(-0.015, 0.025))
